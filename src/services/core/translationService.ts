  ...
  private initializeTranslations(): void {
    const translations = {
      tr: {
        ...
        'success.appointment.todaysRetrieved': 'Bugünkü randevular başarıyla getirildi',
        'success.appointment.monitorRetrieved': 'Randevu monitörü başarıyla getirildi',
        'success.appointment.availableSlotsRetrieved': 'Müsait zaman dilimleri başarıyla getirildi',
        ...
        'success.business.retrieved': 'İş yeri başarıyla getirildi',
        'success.business.minimalRetrieved': 'İş yeri bilgileri başarıyla getirildi',
        'success.business.noBusinessesFound': 'İş yeri bulunamadı',
        ...
        'success.business.hoursRetrieved': 'Çalışma saatleri başarıyla getirildi',
        'success.business.hoursUpdated': 'Çalışma saatleri başarıyla güncellendi',
        'success.business.hoursStatusRetrieved': 'Çalışma saatleri durumu başarıyla getirildi',
        'success.business.hoursOverrideCreated': 'Özel gün saati başarıyla oluşturuldu',
        'success.business.hoursOverrideUpdated': 'Özel gün saati başarıyla güncellendi',
        'success.business.affectedAppointmentsRetrieved': 'Etkilenen randevular başarıyla getirildi',
        'success.business.hoursOverridesRetrieved': 'Özel gün saatleri başarıyla getirildi',
        'success.business.hoursOverrideDeleted': 'Özel gün saati başarıyla silindi',
        'success.business.notificationSettingsRetrieved': 'Bildirim ayarları başarıyla getirildi',
        'success.business.reservationSettingsRetrieved': 'Rezervasyon ayarları başarıyla getirildi',
        'success.business.profilePrivacySettingsRetrieved': 'Profil gizlilik ayarları başarıyla getirildi',
        'success.business.cancellationPoliciesRetrieved': 'İptal politikaları başarıyla getirildi',
        'success.business.cancellationPoliciesUpdated': 'İptal politikaları başarıyla güncellendi',
        'success.business.notificationSettingsUpdated': 'Bildirim ayarları başarıyla güncellendi',
        'success.business.reservationSettingsUpdated': 'Rezervasyon ayarları başarıyla güncellendi',
        'success.business.profilePrivacySettingsUpdated': 'Profil gizlilik ayarları başarıyla güncellendi',
        'success.business.priceSettingsRetrieved': 'Fiyat ayarları başarıyla getirildi',
        'success.business.priceSettingsUpdated': 'Fiyat ayarları başarıyla güncellendi',
        'success.business.staffPrivacySettingsRetrieved': 'Personel gizlilik ayarları başarıyla getirildi',
        'success.business.staffPrivacySettingsUpdated': 'Personel gizlilik ayarları başarıyla güncellendi',
        'success.business.verified': 'İş yeri başarıyla doğrulandı',
        'success.business.unverified': 'İş yeri doğrulaması kaldırıldı',
        'success.business.closed': 'İş yeri kapatıldı',
        'success.business.reopened': 'İş yeri tekrar açıldı',
        'success.business.deleted': 'İş yeri başarıyla silindi',
        'success.business.batchClosed': 'İş yerleri toplu olarak kapatıldı',
        'success.business.paymentMethodAdded': 'Ödeme yöntemi başarıyla eklendi',
        'success.business.paymentMethodsRetrieved': 'Ödeme yöntemleri başarıyla getirildi',
        'success.business.photoUploaded': 'Fotoğraf başarıyla yüklendi',
        'success.business.photoDeleted': 'Fotoğraf başarıyla silindi',
        'success.business.photosRetrieved': 'Fotoğraflar başarıyla getirildi',
        'success.business.googleRatingSynced': 'Google değerlendirmeleri başarıyla senkronize edildi',
        'success.business.customerNoteAdded': 'Müşteri notu başarıyla eklendi',
        'success.business.customerNotesRetrieved': 'Müşteri notları başarıyla getirildi',
        'success.business.customerEvaluationSubmitted': 'Müşteri değerlendirmesi başarıyla gönderildi',
        'success.business.customerEvaluationRetrieved': 'Müşteri değerlendirmesi başarıyla getirildi',
        'success.business.customerLoyaltyStatusRetrieved': 'Müşteri sadakat durumu başarıyla getirildi',
        'success.business.customerPolicyStatusRetrieved': 'Müşteri politika durumu başarıyla getirildi',
        'success.business.customerManagementSettingsRetrieved': 'Müşteri yönetim ayarları başarıyla getirildi',
        'success.business.customerManagementSettingsUpdated': 'Müşteri yönetim ayarları başarıyla güncellendi',
        'success.closure.created': 'Kapatma başarıyla oluşturuldu',
        'success.closure.retrieved': 'Kapatma başarıyla getirildi',
        'success.closure.listRetrieved': 'Kapatmalar başarıyla getirildi',
        'success.closure.updated': 'Kapatma başarıyla güncellendi',
        'success.closure.deleted': 'Kapatma başarıyla silindi',
        'success.closure.statusChecked': 'Kapatma durumu başarıyla kontrol edildi',
        'success.closure.extended': 'Kapatma başarıyla uzatıldı',
        'success.closure.endedEarly': 'Kapatma erken sonlandırıldı',
        'success.closure.statsRetrieved': 'Kapatma istatistikleri başarıyla getirildi',
        'success.closure.holidayCreated': 'Tatil kapatması başarıyla oluşturuldu',
        'success.closure.holidaysRetrieved': 'Tatil kapatmaları başarıyla getirildi',
        'success.closure.affectedAppointmentsRetrieved': 'Etkilenen randevular başarıyla getirildi',
        'success.closure.emergencyCreated': 'Acil kapatma başarıyla oluşturuldu',
        'success.closure.maintenanceCreated': 'Bakım kapatması başarıyla oluşturuldu',
        'success.closure.calendarRetrieved': 'Kapatma takvimi başarıyla getirildi',
        'success.closure.autoExpired': 'Süresi dolan kapatmalar otomatik sonlandırıldı',
        'success.closure.notificationsSent': 'Kapatma bildirimleri başarıyla gönderildi',
        'success.closure.rescheduleSuggestionsRetrieved': 'Yeniden planlama önerileri başarıyla getirildi',
        'success.closure.autoRescheduled': 'Otomatik yeniden planlama tamamlandı',
        'success.closure.analyticsRetrieved': 'Kapatma analizleri başarıyla getirildi',
        'success.closure.customerImpactRetrieved': 'Müşteri etki raporu başarıyla getirildi',
        'success.closure.revenueImpactRetrieved': 'Gelir etki analizi başarıyla getirildi',
        'success.closure.availabilityAlertCreated': 'Müsaitlik uyarısı başarıyla oluşturuldu',
        'success.closure.availabilityAlertDeactivated': 'Müsaitlik uyarısı devre dışı bırakıldı',
        'success.closure.notificationStatsRetrieved': 'Bildirim istatistikleri başarıyla getirildi',
        'success.closure.rescheduleStatsRetrieved': 'Yeniden planlama istatistikleri başarıyla getirildi',
        'success.closure.impactPreviewGenerated': 'Kapatma etki önizlemesi oluşturuldu',
        'success.rating.deleted': 'Değerlendirme başarıyla silindi',
        'success.report.financialRetrieved': 'Finansal rapor başarıyla getirildi',
        'success.report.operationalRetrieved': 'Operasyonel rapor başarıyla getirildi',
        'success.report.qualityRetrieved': 'Kalite raporu başarıyla getirildi',
        'success.report.customerAnalyticsRetrieved': 'Müşteri analiz raporu başarıyla getirildi',
        'success.report.trendsRetrieved': 'Trend raporu başarıyla getirildi',
        'success.report.realtimeRetrieved': 'Anlık rapor başarıyla getirildi',
        'success.role.permissionsRetrieved': 'İzinler başarıyla getirildi',
        'success.role.permissionRetrieved': 'İzin başarıyla getirildi',
        'success.role.permissionUpdated': 'İzin başarıyla güncellendi',
        'success.role.permissionRevoked': 'İzin başarıyla kaldırıldı',
        'success.role.rolePermissionsRetrieved': 'Rol izinleri başarıyla getirildi',
        'success.role.revokedFromUser': 'Rol kullanıcıdan başarıyla kaldırıldı',
        'success.role.userPermissionsRetrieved': 'Kullanıcı izinleri başarıyla getirildi',
        'success.role.myPermissionsRetrieved': 'İzinleriniz başarıyla getirildi',
        'success.role.statisticsRetrieved': 'Rol istatistikleri başarıyla getirildi',
        'success.userBehavior.problematicUsersRetrieved': 'Sorunlu kullanıcılar başarıyla getirildi',
        'success.userBehavior.userBanned': 'Kullanıcı başarıyla yasaklandı',
        'success.userBehavior.userUnbanned': 'Kullanıcı yasağı başarıyla kaldırıldı',
        'success.userBehavior.userFlagged': 'Kullanıcı inceleme için işaretlendi',
        'success.userBehavior.bannedUsersRetrieved': 'Yasaklı kullanıcılar başarıyla getirildi',
        'success.userBehavior.usersWithStrikesRetrieved': 'Uyarılı kullanıcılar başarıyla getirildi',
        'success.userBehavior.automaticStrikesProcessed': 'Otomatik uyarılar işlendi',
        'success.userBehavior.expiredStrikesReset': 'Süresi dolan uyarılar sıfırlandı',
        'success.userBehavior.expiredBansProcessed': 'Süresi dolan yasaklar kaldırıldı',
        'success.userBehavior.batchStrikesAdded': 'Toplu uyarılar başarıyla eklendi',
        'success.userBehavior.batchUsersBanned': 'Kullanıcılar toplu olarak yasaklandı',
        ...
        // Closure Errors
        'errors.business.closureStartInPast': 'Kapatma başlangıç tarihi geçmişte olamaz',
        'errors.business.closureEndBeforeStart': 'Kapatma bitiş tarihi başlangıç tarihinden önce olamaz',
        'errors.business.closureConflict': 'Kapatma dönemi mevcut bir kapatma ile çakışıyor',
        'errors.business.closureNotFound': 'Kapatma bulunamadı',
        ...
        'errors.user.alreadyExists': 'Kullanıcı zaten mevcut',
        'errors.user.locked': 'Hesap kilitlendi',
        'errors.user.deactivated': 'Hesap devre dışı bırakıldı',
        'errors.user.notVerified': 'Hesap doğrulanmamış',

        // Auth extras
        'errors.auth.refreshTokenInvalid': 'Yenileme tokeni geçersiz',
        'errors.auth.verificationCodeNotFound': 'Doğrulama kodu bulunamadı',
        'errors.auth.verificationMaxAttempts': 'Maksimum doğrulama deneme sayısına ulaşıldı. Lütfen {{retryAfter}} saniye sonra tekrar deneyin',

        // Rate Limiting extras
        'errors.system.cooldownActive': 'Lütfen {{cooldownSeconds}} saniye bekleyip tekrar deneyin',
        'errors.system.dailyLimitExceeded': 'Günlük istek limiti aşıldı',
        'errors.system.configurationError': 'Sistem yapılandırma hatası',
        'errors.system.routeNotFound': 'Sayfa bulunamadı',
        'errors.system.resourceConflict': 'Kaynak çakışması',
        'errors.system.operationNotAllowed': 'Bu işleme izin verilmiyor',

        // Validation extras
        'errors.validation.invalidIdFormat': 'Geçersiz kimlik formatı',
        'errors.validation.batchSizeExceeded': 'Toplu işlem limiti aşıldı (maksimum {{maxSize}})',
        'errors.validation.invalidInput': 'Geçersiz giriş',
        'errors.validation.invalidFormat': 'Geçersiz format',

        // Appointment extras
        'errors.appointment.notPendingApproval': 'Randevu onay bekliyor durumunda değil',

        // Customer extras
        'errors.customer.profileIncomplete': 'Müşteri profili eksik',

        // Discount Code
        'errors.discountCode.notFound': 'İndirim kodu bulunamadı',

        // Payment
        'errors.payment.notFound': 'Ödeme bulunamadı',
        'errors.payment.methodNotFound': 'Ödeme yöntemi bulunamadı',

        // Push Notification
        'errors.push.subscriptionNotFound': 'Push aboneliği bulunamadı',
      },
      en: {
        // Notifications
        ...
        'success.business.retrieved': 'Business retrieved successfully',
        'success.business.minimalRetrieved': 'Business info retrieved successfully',
        'success.business.noBusinessesFound': 'No businesses found',
        ...
        'success.business.hoursRetrieved': 'Business hours retrieved successfully',
        'success.business.hoursUpdated': 'Business hours updated successfully',
        'success.business.hoursStatusRetrieved': 'Business hours status retrieved successfully',
        'success.business.hoursOverrideCreated': 'Special day hours created successfully',
        'success.business.hoursOverrideUpdated': 'Special day hours updated successfully',
        'success.business.affectedAppointmentsRetrieved': 'Affected appointments retrieved successfully',
        'success.business.hoursOverridesRetrieved': 'Special day hours retrieved successfully',
        'success.business.hoursOverrideDeleted': 'Special day hours deleted successfully',
        'success.business.notificationSettingsRetrieved': 'Notification settings retrieved successfully',
        'success.business.reservationSettingsRetrieved': 'Reservation settings retrieved successfully',
        'success.business.profilePrivacySettingsRetrieved': 'Profile privacy settings retrieved successfully',
        'success.business.cancellationPoliciesRetrieved': 'Cancellation policies retrieved successfully',
        'success.business.cancellationPoliciesUpdated': 'Cancellation policies updated successfully',
        'success.business.notificationSettingsUpdated': 'Notification settings updated successfully',
        'success.business.reservationSettingsUpdated': 'Reservation settings updated successfully',
        'success.business.profilePrivacySettingsUpdated': 'Profile privacy settings updated successfully',
        'success.business.priceSettingsRetrieved': 'Price settings retrieved successfully',
        'success.business.priceSettingsUpdated': 'Price settings updated successfully',
        'success.business.staffPrivacySettingsRetrieved': 'Staff privacy settings retrieved successfully',
        'success.business.staffPrivacySettingsUpdated': 'Staff privacy settings updated successfully',
        'success.business.verified': 'Business verified successfully',
        'success.business.unverified': 'Business verification removed',
        'success.business.closed': 'Business closed',
        'success.business.reopened': 'Business reopened',
        'success.business.deleted': 'Business deleted successfully',
        'success.business.batchClosed': 'Businesses closed in batch',
        'success.business.paymentMethodAdded': 'Payment method added successfully',
        'success.business.paymentMethodsRetrieved': 'Payment methods retrieved successfully',
        'success.business.photoUploaded': 'Photo uploaded successfully',
        'success.business.photoDeleted': 'Photo deleted successfully',
        'success.business.photosRetrieved': 'Photos retrieved successfully',
        'success.business.googleRatingSynced': 'Google ratings synced successfully',
        'success.business.customerNoteAdded': 'Customer note added successfully',
        'success.business.customerNotesRetrieved': 'Customer notes retrieved successfully',
        'success.business.customerEvaluationSubmitted': 'Customer evaluation submitted successfully',
        'success.business.customerEvaluationRetrieved': 'Customer evaluation retrieved successfully',
        'success.business.customerLoyaltyStatusRetrieved': 'Customer loyalty status retrieved successfully',
        'success.business.customerPolicyStatusRetrieved': 'Customer policy status retrieved successfully',
        'success.business.customerManagementSettingsRetrieved': 'Customer management settings retrieved successfully',
        'success.business.customerManagementSettingsUpdated': 'Customer management settings updated successfully',
        'success.closure.created': 'Closure created successfully',
        'success.closure.retrieved': 'Closure retrieved successfully',
        'success.closure.listRetrieved': 'Closures retrieved successfully',
        'success.closure.updated': 'Closure updated successfully',
        'success.closure.deleted': 'Closure deleted successfully',
        'success.closure.statusChecked': 'Closure status checked successfully',
        'success.closure.extended': 'Closure extended successfully',
        'success.closure.endedEarly': 'Closure ended early',
        'success.closure.statsRetrieved': 'Closure statistics retrieved successfully',
        'success.closure.holidayCreated': 'Holiday closure created successfully',
        'success.closure.holidaysRetrieved': 'Holiday closures retrieved successfully',
        'success.closure.affectedAppointmentsRetrieved': 'Affected appointments retrieved successfully',
        'success.closure.emergencyCreated': 'Emergency closure created successfully',
        'success.closure.maintenanceCreated': 'Maintenance closure created successfully',
        'success.closure.calendarRetrieved': 'Closure calendar retrieved successfully',
        'success.closure.autoExpired': 'Expired closures auto-processed',
        'success.closure.notificationsSent': 'Closure notifications sent successfully',
        'success.closure.rescheduleSuggestionsRetrieved': 'Reschedule suggestions retrieved successfully',
        'success.closure.autoRescheduled': 'Auto-reschedule completed',
        'success.closure.analyticsRetrieved': 'Closure analytics retrieved successfully',
        'success.closure.customerImpactRetrieved': 'Customer impact report retrieved successfully',
        'success.closure.revenueImpactRetrieved': 'Revenue impact analysis retrieved successfully',
        'success.closure.availabilityAlertCreated': 'Availability alert created successfully',
        'success.closure.availabilityAlertDeactivated': 'Availability alert deactivated',
        'success.closure.notificationStatsRetrieved': 'Notification statistics retrieved successfully',
        'success.closure.rescheduleStatsRetrieved': 'Reschedule statistics retrieved successfully',
        'success.closure.impactPreviewGenerated': 'Closure impact preview generated',
        'success.rating.deleted': 'Rating deleted successfully',
        'success.report.financialRetrieved': 'Financial report retrieved successfully',
        'success.report.operationalRetrieved': 'Operational report retrieved successfully',
        'success.report.qualityRetrieved': 'Quality report retrieved successfully',
        'success.report.customerAnalyticsRetrieved': 'Customer analytics report retrieved successfully',
        'success.report.trendsRetrieved': 'Trends report retrieved successfully',
        'success.report.realtimeRetrieved': 'Realtime report retrieved successfully',
        'success.role.permissionsRetrieved': 'Permissions retrieved successfully',
        'success.role.permissionRetrieved': 'Permission retrieved successfully',
        'success.role.permissionUpdated': 'Permission updated successfully',
        'success.role.permissionRevoked': 'Permission revoked successfully',
        'success.role.rolePermissionsRetrieved': 'Role permissions retrieved successfully',
        'success.role.revokedFromUser': 'Role revoked from user successfully',
        'success.role.userPermissionsRetrieved': 'User permissions retrieved successfully',
        'success.role.myPermissionsRetrieved': 'Your permissions retrieved successfully',
        'success.role.statisticsRetrieved': 'Role statistics retrieved successfully',
        'success.userBehavior.problematicUsersRetrieved': 'Problematic users retrieved successfully',
        'success.userBehavior.userBanned': 'User banned successfully',
        'success.userBehavior.userUnbanned': 'User unbanned successfully',
        'success.userBehavior.userFlagged': 'User flagged for review',
        'success.userBehavior.bannedUsersRetrieved': 'Banned users retrieved successfully',
        'success.userBehavior.usersWithStrikesRetrieved': 'Users with strikes retrieved successfully',
        'success.userBehavior.automaticStrikesProcessed': 'Automatic strikes processed',
        'success.userBehavior.expiredStrikesReset': 'Expired strikes reset',
        'success.userBehavior.expiredBansProcessed': 'Expired bans processed',
        'success.userBehavior.batchStrikesAdded': 'Batch strikes added successfully',
        'success.userBehavior.batchUsersBanned': 'Users banned in batch',
        ...
        // Closure Errors
        'errors.business.closureStartInPast': 'Closure start date cannot be in the past',
        'errors.business.closureEndBeforeStart': 'Closure end date must be after start date',
        'errors.business.closureConflict': 'Closure period conflicts with an existing closure',
        'errors.business.closureNotFound': 'Closure not found',
        ...
        'errors.user.alreadyExists': 'User already exists',
        'errors.user.locked': 'Account is locked',
        'errors.user.deactivated': 'Account is deactivated',
        'errors.user.notVerified': 'Account is not verified',

        // Auth extras
        'errors.auth.refreshTokenInvalid': 'Refresh token is invalid',
        'errors.auth.verificationCodeNotFound': 'Verification code not found',
        'errors.auth.verificationMaxAttempts': 'Maximum verification attempts reached. Please try again after {{retryAfter}} seconds',

        // Rate Limiting extras
        'errors.system.cooldownActive': 'Please wait {{cooldownSeconds}} seconds before trying again',
        'errors.system.dailyLimitExceeded': 'Daily request limit exceeded',
        'errors.system.configurationError': 'System configuration error',
        'errors.system.routeNotFound': 'Page not found',
        'errors.system.resourceConflict': 'Resource conflict',
        'errors.system.operationNotAllowed': 'This operation is not allowed',

        // Validation extras
        'errors.validation.invalidIdFormat': 'Invalid ID format',
        'errors.validation.batchSizeExceeded': 'Batch size exceeded (maximum {{maxSize}})',
        'errors.validation.invalidInput': 'Invalid input',
        'errors.validation.invalidFormat': 'Invalid format',

        // Appointment extras
        'errors.appointment.notPendingApproval': 'Appointment is not pending approval',

        // Customer extras
        'errors.customer.profileIncomplete': 'Customer profile is incomplete',

        // Discount Code
        'errors.discountCode.notFound': 'Discount code not found',

        // Payment
        'errors.payment.notFound': 'Payment not found',
        'errors.payment.methodNotFound': 'Payment method not found',

        // Push Notification
        'errors.push.subscriptionNotFound': 'Push subscription not found',
      }
    };
