@echo off
REM Script to run subscription plans seeding in Docker production container (Windows)
...
docker cp scripts/seed-subscription-plans-production.ts %CONTAINER_ID%:/app/scripts/seed-subscription-plans-production.ts
...
REM docker-compose -f docker-compose.production.yml exec app1 rm /app/scripts/seed-subscription-plans-production.ts
