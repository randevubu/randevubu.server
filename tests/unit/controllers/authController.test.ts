...
describe("AuthController", () => {
  ...
  describe("sendVerificationCode", () => {
    it("should send verification code successfully", async () => {
      ...
      mockPhoneVerificationService.sendVerificationCode.mockResolvedValue(
        mockResult
      );
      ...
      // Assert
      expect(
        mockPhoneVerificationService.sendVerificationCode
  ...
  describe("getProfile with business summary", () => {
    it("should get profile with business summary successfully", async () => {
      ...
      mockAuthService.getUserProfileWithBusinessSummary.mockResolvedValue(
        mockProfileWithBusiness
      );
      ...
      // Assert
      expect(
        mockAuthService.getUserProfileWithBusinessSummary
      ).toHaveBeenCalledWith(
        "user-123",
        expect.objectContaining({
          ipAddress: "127.0.0.1",
  ...
  describe("getMyCustomers", () => {
    it("should get user customers successfully", async () => {
      ...
      // Act
      await authController.getMyCustomers(
        mockGuaranteedAuthRequest,
        mockResponse
      );
  ...
  describe("getCustomerDetails", () => {
    it("should get customer details successfully", async () => {
      ...
      // Act
      await authController.getCustomerDetails(
        mockGuaranteedAuthRequest,
        mockResponse
      );

      // Assert
      expect(mockAuthService.getCustomerDetails).toHaveBeenCalledWith(
        "user-123",
        customerId
      );
      expect(mockResponse.status).toHaveBeenCalledWith(200);
